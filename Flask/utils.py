disease_dic = {
    ...
    'Corn_(maize)___Cercospora_leaf_spot Gray_leaf_spot': """ <b>Crop</b>: Corn <br/>Disease: Grey Leaf Spot<br/>
        ...
        <br/><br/>ಜೋಳದ ಎಲೆಗಳ ಮೇಲೆ ಬೂದು ಎಲೆಯ ಚುಕ್ಕೆ ಗಾಯಗಳು ದ್ಯುತಿಸಂಶ್ಲೇಷಕ ಚಟುವಟಿಕೆಯನ್ನು ಅಡ್ಡಿಪಡಿಸುತ್ತದೆ, ಧಾನ್ಯ ತುಂಬುವಿಕೆಯ ಕಡೆಗೆ ಹಂಚಿಕೆಯಾದ ಕಾರ್ಬೋಹೈಡ್ರೇಟ್‌ಗಳನ್ನು ಕಡಿಮೆ ಮಾಡುತ್ತದೆ. ಧಾನ್ಯ ತುಂಬುವಿಕೆಗೆ ಸಂಬಂಧಿಸಿದಂತೆ ಎಲೆಗಳು ಸೋಂಕಿಗೆ ಒಳಗಾದ ಪ್ರಮಾಣವನ್ನು ಆಧರಿಸಿ ಬೂದು ಎಲೆ ಚುಕ್ಕೆ ಬೆಳೆ ಇಳುವರಿಯನ್ನು ಎಷ್ಟು ಪ್ರಮಾಣದಲ್ಲಿ ಹಾನಿಗೊಳಿಸುತ್ತದೆ ಎಂದು ಅಂದಾಜು ಮಾಡಬಹುದು. ಪರಾಗಸ್ಪರ್ಶದ ಸಮಯದಲ್ಲಿ ಕಿವಿಯ ಎಲೆಯನ್ನು ದಾಟಿದ ಗಾಯಗಳನ್ನು ಅಭಿವೃದ್ಧಿಪಡಿಸುವಾಗ ಹಾನಿ ಹೆಚ್ಚು ತೀವ್ರವಾಗಿರುತ್ತದೆ. ಎಲೆಗಳ ಕಾರ್ಯನಿರ್ವಹಣೆಯಲ್ಲಿನ ಇಳಿಕೆಯು ಧಾನ್ಯ ತುಂಬುವಿಕೆಗೆ ಮೀಸಲಾದ ದ್ಯುತಿಸಂಶ್ಲೇಷಕಗಳನ್ನು ಮಿತಿಗೊಳಿಸುತ್ತದೆ, ಸಸ್ಯವು ಕಾಳುಗಳನ್ನು ತುಂಬಲು ಕಾಂಡದಿಂದ ಹೆಚ್ಚು ಕಾರ್ಬೋಹೈಡ್ರೇಟ್‌ಗಳನ್ನು ಸಜ್ಜುಗೊಳಿಸಬಹುದು.
        <br/><br/> How to prevent/cure the disease/ರೋಗವನ್ನು ತಡೆಗಟ್ಟುವುದು / ಗುಣಪಡಿಸುವುದು ಹೇಗೆ <br/>
        ...
        <br/>1. ಕಾರ್ನ್ ಗ್ರೇ ಲೀಫ್ ಸ್ಪಾಟ್ ಅನ್ನು ಉತ್ತಮವಾಗಿ ತಡೆಗಟ್ಟಲು ಮತ್ತು ನಿರ್ವಹಿಸಲು, ಒಟ್ಟಾರೆ ವಿಧಾನವು ರೋಗದ ಬೆಳವಣಿಗೆ ಮತ್ತು ವಿಸ್ತರಣೆಯ ದರವನ್ನು ಕಡಿಮೆ ಮಾಡುವುದು
        ...
        <br/>2. ಸೆಕೆಂಡರಿ ಕಾಯಿಲೆಯ ಚಕ್ರಗಳ ಪ್ರಮಾಣವನ್ನು ಸೀಮಿತಗೊಳಿಸುವ ಮೂಲಕ ಮತ್ತು ಕಾರ್ನ್ ಧಾನ್ಯ ರಚನೆಯ ನಂತರ ಎಲೆಗಳ ಪ್ರದೇಶವನ್ನು ಹಾನಿಯಿಂದ ರಕ್ಷಿಸುವ ಮೂಲಕ ಇದನ್ನು ಮಾಡಲಾಗುತ್ತದೆ.
        
        <br/>3. High risk factors for grey leaf spot in corn:/
        ಜೋಳದಲ್ಲಿ ಬೂದು ಎಲೆ ಮಚ್ಚೆಗೆ ಹೆಚ್ಚಿನ ಅಪಾಯಕಾರಿ ಅಂಶಗಳು:<br/>
